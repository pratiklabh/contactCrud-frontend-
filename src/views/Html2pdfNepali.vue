<template>
  <div class="table-container">
    ...
    <DataTable :value="salesDetails" tableStyle="min-width: 50rem">
      <Column field="date" header="मिति"/>
      <Column field="total" header="उप कुल रकम"/>
      <Column field="customerName" header="ग्राहकको नाम"/>
      <Column field="paymentMode" header="भुक्तानी मोड"/>
      <Column header="कार्यहरू">
    ...
    <Dialog v-model:visible="dialogVisible" header="Sales Details" :modal="true" :closable="true" style="width: 50vw">
      <template v-if="selectedSalesDetail">
        <h3 :style="{ textAlign: clientPreferences.customer_name_align }">ग्राहकको नाम {{ selectedSalesDetail.customerName }}</h3>
        <table style="width: 100%; border-collapse: collapse; text-align: center;">
          <thead>
          <tr>
            <th style="border: 1px solid #000;">वस्तुको नाम</th>
        ...
        <h3>कुल रकम: {{ grandTotal }}</h3>
        <Button label="छाप्नुहोस्" @click="openPrintSizeDialog"/>
      </template>
    </Dialog>

    <!-- Dialog for Print Size Selection -->
    <Dialog v-model:visible="printSizeDialogVisible" header="ग्राहक र कागज आकार चयन गर्नुहोस्" :modal="true" :closable="true" style="width: 30vw">
      <div>
        <p>PDF को लागि ग्राहक र कागज आकार चयन गर्नुहोस्:</p>

        <!-- Select Client Dropdown -->
        <Select v-model="selectedClientId" :options="clients" optionLabel="client_name" optionValue="client_id" placeholder="ग्राहक चयन गर्नुहोस्:" @change="fetchClientPreferences"/>

        <!-- Select Paper Size Dropdown -->
        <Select v-model="selectedPaperSize" :options="paperSizes" optionLabel="label" optionValue="value" placeholder="कागज आकार चयन गर्नुहोस्:"/>

        <div style="margin-top: 1rem;">
          <Button label="पुष्टि गर्नुहोस्" @click="confirmPrint"/>
        </div>
      </div>
    </Dialog>
  </div>
